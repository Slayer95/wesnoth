...
class WmlNodeSentence:
    def __init__(self, sentence, *, ismultiline, macro=None,
                 fileref, lineno, lineno_sub=0, plural=None,
...
class WmlNode:
    ...
    def add_sentence(self, sentence, *, macro=None, ismultiline, lineno, lineno_sub=0,
